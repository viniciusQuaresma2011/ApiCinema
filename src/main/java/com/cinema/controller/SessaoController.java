...
public class SessaoController {
	...
	public Sessao createSession(@RequestBody @Valid  Sessao sessao) throws Exception {
	...
	public ResponseEntity<Sessao> editSessionById(@PathVariable("id") Long id, @RequestBody @Valid Sessao sessao) throws Exception{
		...
		opcionalSessao.setInicio(sessao.getInicio());
		opcionalSessao.setFim(sessao.getFim());
		opcionalSessao.setSala(sessao.getSala());
		opcionalSessao.setValor_sessao(sessao.getValor_sessao());
