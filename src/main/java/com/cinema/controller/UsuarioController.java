...
public class UsuarioController {
	...
	@PostMapping("/cadastro/usuario/salvar")
	...
	public ResponseEntity<Usuario> editUserById(@PathVariable("id") Long id, @RequestBody @Valid Usuario usuario) throws Exception {
