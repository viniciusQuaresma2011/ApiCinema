...
public class IngressoController {
	...
	public ResponseEntity<Ingresso> editTicketById(@PathVariable("id") Long id, @RequestBody Ingresso ingresso) throws Exception{
		...
		localizarIngresso.setUsuario(ingresso.getUsuario());
		localizarIngresso.setData(ingresso.getData());
		localizarIngresso.setHorario(ingresso.getHorario());
		localizarIngresso.setSituacao(ingresso.getSituacao());
		localizarIngresso.setFilme(ingresso.getFilme());
